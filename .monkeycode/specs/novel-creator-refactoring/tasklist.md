...
- [x] 50. 创建 StoryView — 故事体系视图
  - 总纲展示(一句话+冲突+主题)
  - 卷纲预览(卡片列表,每卷显示摘要+钩子)
  - 事件时间线(全部plot_events可视化)
  - 编辑模式: 可手动调整事件位置

- [x] 51. 创建 PlanningView — 规划层视图
