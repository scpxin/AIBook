...
async def directory(book_id: str = ''):
    if not book_id:
...
async def download_start(book_id: str = '', title: str = ''):
    if not book_id:
        return {"error": "missing book_id"}
...
async def download_pause(session_id: str = ''):
...
async def download_saved(book_id: str = ''):
...
async def downloads_content(book_id: str = ''):
