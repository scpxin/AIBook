...
.loading, .empty { color: #999; font-size: 12px; padding: 8px 0; }
.knowledge-item { display: flex; font-size: 11px; padding: 3px 0; border-bottom: 1px solid #f5f5f5; }
.knowledge-item .key { font-weight: 600; margin-right: 6px; color: #555; flex-shrink: 0; }
