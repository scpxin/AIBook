...
export const useIdeaStore = defineStore('idea', () => {
  ...
  async function generateIdeasLocal(pid: string, prompt: string, genre?: string) {
  ...
  return {
    ...
    generate, score, upgrade, analyzeRisks, select, generateIdeas: generateIdeasLocal, upgradeIdea: upgradeIdeaLocal,
  }
})
