...
def app(tmp_db_path):
    ...
    with patch("app.database.novel_db.init_db"), \
         ...
         patch("app.services.settings_service.get_all_settings", mock_db_v2.get_all_settings), \
         patch("app.services.settings_service.set_setting", mock_db_v2.set_setting), \
